    ...
    <div id="add-variable-content">
        ...
        <div class="container">
            ...
            <div class="row justify-content-between align-items-center p-3">
                ...
                <h6 style="max-width: 80%; line-height: 1.25rem;" class="mb-0 text-uppercase font-weight-normal d-none" id="dont-forget">Wait! Dont' forget</h6>
            ...
            <div class="row justify-content-between align-items-center p-3">
                ...
                <button class="btn btn-dark text-uppercase rounded-0 w-100 d-none" style="font-size:0.85rem;" id="go-checkout">Proceed to Checkout</button>
